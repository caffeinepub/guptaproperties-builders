...
import type { ExternalBlob as _ExternalBlob, Property as _Property, PropertyInput as _PropertyInput, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProperty(arg0: PropertyInput): Promise<Property> {
        if (this.processError) {
            try {
                const result = await this.actor.createProperty(await to_candid_PropertyInput_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_Property_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateProperty(arg0: bigint, arg1: PropertyInput): Promise<Property> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProperty(arg0, await to_candid_PropertyInput_n10(this._uploadFile, this._downloadFile, arg1));
                return from_candid_Property_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Property_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Property): Promise<Property> {
...
async function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Property]): Promise<Property | null> {
    return value.length === 0 ? null : await from_candid_Property_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Property>): Promise<Array<Property>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Property_n13(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_PropertyInput_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PropertyInput): Promise<_PropertyInput> {
