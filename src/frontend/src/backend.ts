...
import type { Property as _Property, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProperty(arg0: string, arg1: string, arg2: bigint | null, arg3: string | null, arg4: Array<string>, arg5: string | null): Promise<Property> {
        if (this.processError) {
            try {
                const result = await this.actor.createProperty(arg0, arg1, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n4(this._uploadFile, this._downloadFile, arg3), arg4, to_candid_opt_n4(this._uploadFile, this._downloadFile, arg5));
                return from_candid_Property_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateProperty(arg0: bigint, arg1: string, arg2: string, arg3: bigint | null, arg4: string | null, arg5: Array<string>, arg6: string | null): Promise<Property> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProperty(arg0, arg1, arg2, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n4(this._uploadFile, this._downloadFile, arg4), arg5, to_candid_opt_n4(this._uploadFile, this._downloadFile, arg6));
                return from_candid_Property_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Property_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Property): Property {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Property]): Property | null {
    return value.length === 0 ? null : from_candid_Property_n5(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        video: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.video)),
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Property>): Array<Property> {
    return value.map((x)=>from_candid_Property_n5(_uploadFile, _downloadFile, x));
}
